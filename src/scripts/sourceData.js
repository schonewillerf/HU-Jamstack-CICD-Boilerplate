...
const client = contentful.createClient({
    space: '4wgs1ergvmwg', // Insert Contentful Space ID
    accessToken: 'PszJa5h1N27RWNSCiiKsXvQFKyzw7F2Il4FCHuyzMUM' // Insert Contentful Content Delivery API access token
});
